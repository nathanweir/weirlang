...
:::tip
If you use [direnv](https://direnv.net/), entering the project directory automatically activates the Nix environment — no manual `nix develop` needed.
:::
...
A Zed extension is available at `/home/nathan/dev/zed-weir` providing:
